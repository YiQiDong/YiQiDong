...
namespace YiQiDong.Components.Pages
{
    ...
    {        
        ...
        private IEnumerable<ToolInfo> GetTools()
        {
            ...
            yield return ToolInfo.Create<Quick.Blazor.Bootstrap.Admin.CommandInterpreter>("系统管理", "命令解释器", "fa fa-terminal");
            ...
            yield return ToolInfo.Create<Glash.Blazor.Agent.Pages.ProfileManage>("代理工具", "Glash代理端", "fa fa-black-tie");
