...
{
    public class Runtime_java_sdk : IResource
    {
        public string Id => "java-sdk";

        public string Name => "Java SDK";
        ...
        private ReleaseAsset getJavaRuntimeAsset(HttpClient client, string javaVersion, string arch,out string jreVersion)
        {
            ...
            var release = releaseResult.Assets
                .FirstOrDefault(t => t.Name.Contains("jdk_" + arch) && t.Name.EndsWith(fileExt));
            return release;
        }
