...
{
    public static async ValueTask<Protocol.V1.QpCommands.OpenFunctionSession.Response> Execute(Quick.Protocol.QpChannel channel, Protocol.V1.QpCommands.OpenFunctionSession.Request request)
    {
