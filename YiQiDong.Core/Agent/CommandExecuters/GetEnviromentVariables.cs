...
{
    public static Protocol.V1.QpCommands.GetEnviromentVariables.Response Execute(Quick.Protocol.QpChannel channel, Protocol.V1.QpCommands.GetEnviromentVariables.Request request)
    {
