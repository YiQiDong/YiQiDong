...
{
    public static async ValueTask<Protocol.V1.QpCommands.CloseFunctionSession.Response> Execute(Quick.Protocol.QpChannel channel, Protocol.V1.QpCommands.CloseFunctionSession.Request request)
    {
